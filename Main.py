...
class DataAnalysis(object):
    ...
    def reduction_analysis(self):
        ...
        n_samples, n_feature = self.x.shape
        ...
        def embedding_plot(x, title):
            ...
            for i in range(x.shape[0]):
                ...
                ax.add_artist(offsetbox.AnnotationBbox(offsetbox.OffsetImage(self.digits.images[i], cmap=plt.cm.gray_r), x[i]))
        ...
        embedding_plot(self.x, 'PCA')
        plt.show()


data = DataAnalysis()
data.open_files("Xvar.csv", "Yvar.csv")
# data.plot_x_y_var()
# data.bar_chart()
# data.pivot()
